...
if($_POST['submit'])
{
$query=mysql_query("select pembelian.Tgl_Pembelian,barang.Nama,detail_pembelian.Harga_Beli,Byk_Beli,(detail_pembelian.Harga_Beli*detail_pembelian.Byk_Beli) as Total from pembelian,detail_pembelian,barang where pembelian.ID=detail_pembelian.ID_Pembelian and barang.ID=detail_pembelian.ID_Barang and pembelian.Tgl_Pembelian like'$Thn-$Bln-$Tgl%'");

$T=mysql_query("select SUM(detail_pembelian.Harga_Beli*detail_pembelian.Byk_Beli) as Total from pembelian,detail_pembelian,barang where pembelian.ID=detail_pembelian.ID_Pembelian and barang.ID=detail_pembelian.ID_Barang and pembelian.Tgl_Pembelian like'$Thn-$Bln-$Tgl%'");
...
<h5 align="center"><font face="Monotype Corsiva" size="7" color="#000000"> Laporan Pembelian Barang  <br /> <?php if($Tgl=='%'){echo"";}else{echo"$Tgl";} echo" ";  
if($Bln=='%'){echo"";}
 ...
 echo" ";  
if($Thn=='%'){echo"";}else{echo"$Thn";} ?> </font> </h5>

<p>Masukkan Tanggal Pembelian : <br />
    <select name="Tgl">
      <?php
		include "koneksi.php";
...
<tr>
  ...
  <td colspan="5" align="right"> <br /> <br /></td>
  </tr>
</table>
...
{
header("location:ReportPembelianAll.php");
}
?>
<form action="ReportPembelian.php" method="post">
<table align="center">
<tr>
<td>
<label>
