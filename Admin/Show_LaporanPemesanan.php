...
$query=mysql_query("select pemesanan.Tgl_Pesan,barang.Nama,detail_pemesanan.Harga,Byk_Pesan,(detail_pemesanan.Harga*detail_pemesanan.Byk_Pesan) as Total from pemesanan,detail_pemesanan,barang where pemesanan.ID=detail_pemesanan.ID_Pemesanan and barang.ID=detail_pemesanan.ID_Barang");

$T=mysql_query("select SUM(detail_pemesanan.Harga*detail_pemesanan.Byk_Pesan) as Total from detail_pemesanan");
...
?>
<form action="ReportPemesananAll.php" method="post">
<h5 align="center"><font face="Monotype Corsiva" size="7" color="#000000"> Laporan Pemesanan </font></h5>
...
<tr>
  ...
  <td colspan="5" align="center"> <br /> <br /><input type="submit" name="printall" value="Cetak Laporan" /> </td>
  </tr>
</table>
