...
<?php
include "koneksi.php";
$query=mysql_query("select pembelian.ID,barang.Nama,pegawai.Nama,pembelian.Tgl_Pembelian from barang,pegawai,pembelian where barang.ID=pembelian.ID_Barang and pegawai.ID=pembelian.ID_Pegawai order by pembelian.ID");
